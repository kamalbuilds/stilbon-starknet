...
const About = () => {
	const features = [
		...
		},
		{
			title: 'Our Solution',
			description:
				'StilBon simplifies liquidity management with real-time insights, optimizing capital efficiency across multiple DeFi protocols and blockchains—your all-in-one solution for liquidity pool management.',
		},
		{
			title: 'Our Mission',
			description:
